...
//itens para coleta, pegar todos os li's
...
function handleSelectedItem(event) {
    ...
    if (alreadySelected >= 0) {  //tirar da seleção
    ...
    //atualizar o campo escondido com itens selecionados -- document.querySelector("input[name=items]")
